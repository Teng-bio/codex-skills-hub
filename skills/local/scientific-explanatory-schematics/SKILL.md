...
description: Create, critique, or redesign high-quality scientific explanatory schematics for paper notes, project technical-route notes, mechanism diagrams, graphical abstracts, Obsidian/PPT reading aids, and source Figure/Table explanations. Use when users mention 技术路线图, 机制图, 原理图, 补充图, 一图流, graphical abstract, workflow schematic, figure quality, 论文Figure讲解, 插图太丑/不好看, or need to decide whether to add a self-drawn figure versus relying on original paper figures. Prioritizes original Figure/Table evidence, visual hierarchy, evidence boundaries, and optional-only schematics.
---
